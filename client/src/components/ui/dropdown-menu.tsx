...
function DropdownMenuContent({
  ...
  const staticClasses =
    "data-[state=open]:animate-none data-[state=closed]:animate-none data-[state=open]:transition-none data-[state=closed]:transition-none"
  ...
  const content = (
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        baseClasses,
        disableAnimations ? staticClasses : animatedClasses,
        className
      )}
      {...props}
    />
